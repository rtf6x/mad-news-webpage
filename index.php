...
class MadNews {
  ...
  // @todo некоторые фразы очень часто повторяются, что наводит на мысль о введении дополнительного веса, который будет влиять на статистическое распределение
