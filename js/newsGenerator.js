var predict = [
  ...
  { 'message': '[15_ЛЕТНИЙ|10] [ШКОЛЬНИК]', 'sex': 'm' },
  { 'message': '[15_ЛЕТНЯЯ|10] [ШКОЛЬНИЦА]', 'sex': 'f' }, // иногда не сходится со второй фразой, например "НЕ ПУСТИЛА МУЖА НА РЫБАЛКУ"
  { 'message': '[ДВЕ|10] [15_ЛЕТНИЕ|10] [ШКОЛЬНИЦЫ]', 'sex': 'plural' },
  
  { 'message': '[15_ЛЕТНИЙ|10] [ШКОЛЬНИК] из [ГОРОДА]', 'sex': 'm' },
  { 'message': '[15_ЛЕТНЯЯ|10] [ШКОЛЬНИЦА] из [ГОРОДА]', 'sex': 'f' },
  { 'message': '[ДВЕ|10] [15_ЛЕТНИЕ|10] [ШКОЛЬНИЦЫ] из [ГОРОДА]', 'sex': 'plural' },
  ...
  { 'message': 'В [ГОРОДЕ] [15_ЛЕТНИЙ|10] [ШКОЛЬНИК]', 'sex': 'm' },
  { 'message': 'В [ГОРОДЕ] [15_ЛЕТНЯЯ|10] [ШКОЛЬНИЦА]', 'sex': 'f' },
  { 'message': 'В [ГОРОДЕ] [ДВЕ|10] [15_ЛЕТНИЕ|10] [ШКОЛЬНИЦЫ]', 'sex': 'plural' },
  ...
  { 'message': '[САРАТОВСКИЙ] [МУЖЧИНА]', 'sex': 'm' },
  { 'message': '[САРАТОВСКИЕ] [ЛЮДИ]', 'sex': 'plural' },
  { 'message': '[САРАТОВСКАЯ] [ЖЕНЩИНА]', 'sex': 'f' },
  { 'message': '[САРАТОВСКИЕ] [ЖЕНЩИНЫ]', 'sex': 'plural' },
  { 'message': '[САРАТОВСКИЙ] [ШКОЛЬНИК]', 'sex': 'm' },
  { 'message': '[САРАТОВСКАЯ] [ШКОЛЬНИЦА]', 'sex': 'f' },
...
var sets = {
  ...
  'СЛУЧАЙНО': ['слуйчайно', '', '', '', ''],
  'ДВА': ['Два', 'Три', 'Четыре', 'Двадцать два'],
  'ДВЕ': ['Две', 'Три', 'Четыре', '23'],
...
var action = {
  'm': [
    ...
    'УКРАЛ [СОБАКУ]',
    'украл выручку',
    'украл катафалк и увёз его в деревню',
  ...
  'plural': [
    ...
    'подрались из-за трусов в бобруйском секонд-хенде',
    'пошли на рыбалку',
...
var conclusion = {
  'm': [
    ...
    'и уехал без шапки на товарняке во Владивосток',  
    'И УМЕР',
